			...
			<div class="col-md-7 na_s">
				<form class="navbar-form navbar-left" role="search">
			        <div class="form-group">
			          	<input type="text" class="form-control sosuk" style="">
			        </div>
		        ...
		        <ul class="ul_o">
					...
					<li class="pull-left text-center"><a href="#">香水</a></li>
					<li class="pull-left text-center"><a href="#">眼霜</a></li>
					<li class="pull-left text-center"><a href="#">口红</a></li>
					<li class="pull-left text-center"><a href="#">护肤套装</a></li>
					<li class="pull-left text-center" style="border-right:0px;"> <a href="#">BB霜</a></li>
		        </ul>
			</div>
