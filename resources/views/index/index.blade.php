	...
	<div class="col-md-12" style="height:320px;">
		<div id="carousel-example-generic" class="carousel slide col-md-12" data-ride="carousel">
		  ...
		  <ol class="carousel-indicators">
		    ...
		    @foreach($atr as $k => $p)
		    <li data-target="#carousel-example-generic" data-slide-to="{{$p->id}}"></li>
		    @endforeach
		  </ol>
		  ...
		  <div class="carousel-inner" role="listbox">
		    ...
		    <div class="item active">
		      <img src="/images/lunbo15.jpg" style="height: 300px; width: 1289px;" alt="..." >
		      <div class="carousel-caption">
		      </div>
		    </div>
			@foreach($atr as $k => $p)
		    <div class="item">
		      <img src="{{$p->url}}" style="height: 300px; width: 1289px;" alt="...">
		      <div class="carousel-caption">
		      </div>
		    </div>
		   @endforeach
