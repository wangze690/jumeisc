...
<div class="right" style="margin-top:50px;">
	<form class="form-horizontal" action="/xqgl" method="post" enctype="multipart/form-data">
  		<div class="form-group">
    	<label for="inputPassword3" class="col-sm-2 control-label">商品ID</label>
    		<div class="col-sm-5">
      		<input type="text" class="form-control" id="inputPassword3" placeholder="请填写商品ID" name="sp_id">
    		</div>
  		</div>
  		<div class="form-group">
    	...
    	<label for="inputPassword3" class="col-sm-2 control-label">出产地(中文)</label>
    		<div class="col-sm-5">
      		<input type="text" class="form-control" id="inputPassword3" placeholder="请填写出产地" name="from_2">
    		</div>
  		</div>
  		<div class="form-group">
    	<label for="inputPassword3" class="col-sm-2 control-label">出产地(英文)</label>
    		<div class="col-sm-5">
      		<input type="text" class="form-control" id="inputPassword3" placeholder="请填写出产地" name="from_3">
    		</div>
  		</div>
  		<div class="form-group">
    	<label for="inputPassword3" class="col-sm-2 control-label">商品信息</label>
    		<div class="col-sm-5">
      		<script id="xinxi" name="xinxi" type="text/plain" style="width:900px;height:500px;"></script>
    		</div>
  		</div>
  		<div class="form-group">
    	<label for="inputPassword3" class="col-sm-2 control-label">商品详情</label>
    		<div class="col-sm-5">
      	  <script id="xiangqing" name="xiangqing" type="text/plain" style="width:900px;height:500px;"></script>
    		</div>
  		</div>
  		<div class="form-group">
    	<label for="inputPassword3" class="col-sm-2 control-label">使用方法</label>
    		<div class="col-sm-5">
      		<script id="fangfa" name="fangfa" type="text/plain" style="width:900px;height:500px;"></script>
    		</div>
  		</div>
  		<div class="form-group">
    	<label for="inputPassword3" class="col-sm-2 control-label">商品实拍</label>
    		<div class="col-sm-5">
      		<script id="shipai" name="shipai" type="text/plain" style="width:900px;height:500px;"></script>
    		</div>
  		</div>
  		<div class="form-group">
    	<label for="inputPassword3" class="col-sm-2 control-label">关于聚美极速免税店</label>
    		<div class="col-sm-5">
      		<script id="jisu" name="jisu" type="text/plain" style="width:900px;height:500px;"></script>
    		</div>
  		</div>
  		{{csrf_field()}}
  		<div class="form-group">
